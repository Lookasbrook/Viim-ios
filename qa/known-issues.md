...
| P0-006 | 2026-07-02 | 🔴 Bloquant | Backend Viim déployé mais health check en `degraded` car `NEWAGENT_URL` et `NEWAGENT_TOKEN` ne sont pas configurés dans Coolify. | Backend / NEwAGENT-IA | Ajouter les vrais secrets `NEWAGENT_URL` et `NEWAGENT_TOKEN` dans Coolify, puis redéployer ou redémarrer l'app Viim. |
